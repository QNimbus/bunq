...
#   timestamp: 2023-12-05T05:40:51+00:00
...
class AddressType(BaseModel):
    ...
    is_user_address_updated: Optional[bool] = None
...
class EventType(Enum):
    ...
    REQUEST_INQUIRY_BATCH_CREATED = 'REQUEST_INQUIRY_BATCH_CREATED'
    BILLING_INVOICE_SETTLED = 'BILLING_INVOICE_SETTLED'
...
class PaymentAutoAllocateInstanceClass(BaseModel):
    model_config = ConfigDict(
        extra='forbid',
    )
    id: int
...
class CashbackPayoutItem1(BaseModel):
    id: int
    created: DateTimeType
    updated: DateTimeType
    amount: AmountType
...
class CashbackPayoutItem(BaseModel):
    ...
    CashbackPayoutItem: CashbackPayoutItem1
...
class InvoiceType(BaseModel):
    ...
    category: str
    group: List
    total_vat_exclusive: AmountType
    total_vat_inclusive: AmountType
    total_vat: AmountType
    alias: AliasOrCounterpartyAlias
    counterparty_alias: AliasOrCounterpartyAlias
    address: Optional[AddressType] = None
    counterparty_address: Optional[AddressType] = None
...
class PaymentAutoAllocateInstance(BaseModel):
    ...
    PaymentAutoAllocateInstance: PaymentAutoAllocateInstanceClass
...
class MasterCardActionType(BaseModel):
    ...
    eligible_whitelist_id: Optional[int] = None
    cashback_payout_item: Optional[CashbackPayoutItem] = None
...
class PaymentType(BaseModel):
    ...
    payment_auto_allocate_instance: Optional[PaymentAutoAllocateInstance] = None


class RequestInquiryBatchType(BaseModel):
    id: int
    created: DateTimeType
    updated: DateTimeType
    request_inquiries: List[RequestInquiryType]
    reference_split_the_bill: Optional[Dict[str, Any]] = None
    total_amount_inquired: AmountType
...
class RequestInquiryBatch(BaseModel):
    RequestInquiryBatch: RequestInquiryBatchType
